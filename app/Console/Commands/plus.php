...
//        for ($i=13500;$i<14518;$i++){
//
//            $nodel =  "https://m.gaoxiaogif.com/zhenrengif/".$i.".html";
//            $a = Redis::lpush ('gaoxiao' , $nodel);
//
//        }
//        dd(1);
//        [
...
//            ],
        $requests = function ( $total ) use ( $client ) {
            while (true) {
                $key = empty(Redis::keys ('gaoxiao')[ 0 ]) ? null : Redis::keys ('gaoxiao')[ 0 ];
//                $key = 'https://www.woyaogexing.com/touxiang/nv/2019/780849.html';
                if ( is_null ($key) ) {
                    dd ('停止');
                }
                $uri = Redis::lpop ('gaoxiao');
//
...
//                $uri = 'https://m.gaoxiaogif.com/zhenrengif/14517.html';
        ...
        $pool = new Pool($client , $requests($this->totalPageCount) , [
            ...
            'fulfilled'   => function ( $response , $index ) {
                ...
                try {
                    ...
                    $title  = $crawler->filterXPath ('//h3/a')->text ();
                    $img  = $crawler->filterXPath ('//div[@class="tex1_center"]/p[2]/img/@src')->text ();
//                    dd($title,$img);
